...
func init() {
	...
	flag.Float64Var(&score, "s", defaultScore, "minimum score for which matches will be reported")
	flag.Float64Var(&score, "score", defaultScore, "minimum score for which matches will be reported")
	flag.StringVar(&modelFileName, "m", defaultModelName, "word2vec model filename")
	flag.StringVar(&modelFileName, "model", defaultModelName, "word2vec model filename")
}
...
func main() {
	...
	matches := compare(a, b, fileName1, fileName2, model)
...
func compare(a, b []string, fileName1, fileName2 string, model *word2vec.Model) []matchGroup {
